  ...
  useEffect(() => {
    if (htmlCode || cssCode || jsCode) {
      const timer = setTimeout(() => {
        document
          .querySelector(".preview-refresh")
          ?.classList.add("animate-ping-once");
        setTimeout(() => {
          document
            .querySelector(".preview-refresh")
            ?.classList.remove("animate-ping-once");
        }, 500);
      }, 300);
    ...
    <div className={themeClasses.container}>
            ...
            <button
              className={
                theme === "dark"
                  ...
                  : "bg-gray-200 hover:bg-gray-300 p-2 rounded-full transition-colors"
              }
          ...
          <div className="text-center p-6 rounded-2xl bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 shadow-2xl">
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-400 max-w-md">
                AI is crafting your code based on your description. This usually
                takes 10-20 seconds...
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-center py-3 sm:py-4 gap-3 sm:gap-0">
            <Link to="/" className="flex items-center space-x-3">
              ...
              <h1 className="text-3xl sm:text-4xl font-extrabold tracking-wide text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-violet-500 font-[Orbitron]">
                PATHMIND
              </h1>
            </Link>
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            >
              <div className={themeClasses.cardInner}>
                ...
                <div
                  className={`${themeClasses.previewContainer} h-[350px] sm:h-[400px] md:h-[500px] lg:h-[600px] xl:h-[700px]`}
                >
                  {htmlCode || cssCode || jsCode ? (
                    <iframe
                      key={previewKey}
                    ...
                    <div className={themeClasses.previewPlaceholder}>
                      <div className="text-center px-4">
                        <div
                          className={
                            theme === "dark"
                              ? "bg-gray-800/50 rounded-full p-4 sm:p-6 inline-block mb-4 sm:mb-6"
                              : "bg-gray-200/80 rounded-full p-4 sm:p-6 inline-block mb-4 sm:mb-6"
                          }
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="absolute bottom-3 right-3 sm:bottom-4 sm:right-4 z-20 flex space-x-2">
                    ...
                    >
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          d="M3 4a1 1 0 011-1h4a1 1 0 010 2H6.414l2.293 2.293a1 1 0 11-1.414 1.414L5 6.414V8a1 1 0 01-2 0V4zm9 1a1 1 0 110-2h4a1 1 0 011 1v4a1 1 0 11-2 0V6.414l-2.293 2.293a1 1 0 11-1.414-1.414L13.586 5H12zm-9 9a1 1 0 012 0v1.586l2.293-2.293a1 1 0 111.414 1.414L6.414 15H8a1 1 0 110 2H4a1 1 0 01-1-1v-4zm13-1a1 1 0 011 1v1.586l1.293-1.293a1 1 0 111.414 1.414L16.414 15H15a1 1 0 110-2h4a1 1 0 011 1v4a1 1 0 01-1 1h-4a1 1 0 110-2h1.586l-1.293-1.293a1 1 0 111.414-1.414l1.293 1.293V13a1 1 0 011-1z"
                          clipRule="evenodd"
                        />
                      </svg>
                    </button>
            ...
            >
              <div className={themeClasses.cardInner}>
                ...
                <div className="relative">
                  ...
                  />
                  {loading && (
                    <div className="shimmer-text-content absolute inset-0 rounded-xl"></div>
                  )}
                </div>
                <div
                ...
                <div className="flex border-b border-gray-700">
                  {["html", "css", "js"].map((tab) => (
                    ...
                    >
                      {tab.toUpperCase()}
                      <span
                        className={`absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-blue-500 to-purple-500 transition-transform duration-300 transform scale-x-0 group-hover:scale-x-100 ${
      ...
      <style jsx>{`
        ...
        .shimmer-code-content {
          ...
          background-size: 100% 100%, 100% 30px, 30px 30px;
